...
/// </summary>
public sealed class UserFileProjectionSpec : BaseSpec<UserFileProjectionSpec, UserProfile, UserFileDTO>
{
    /// <summary>
    /// Note that the specification projects the UserFile onto UserFileDTO together with the referenced User entity properties.
    /// </summary>
    protected override Expression<Func<UserProfile, UserFileDTO>> Spec => e => new()
    {
        Id = e.Id,
        Name = e.Name,
