...
public class UserFileService : IUserFileService
{
    ...
    {
        var userFile = await _repository.GetAsync<UserProfile>(id, cancellationToken); // First get the file entity from the database to find the location on the filesystem.
